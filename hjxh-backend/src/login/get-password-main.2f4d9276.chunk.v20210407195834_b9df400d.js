  ...
  [2],
  {
    203: function (e, n, t) {
        ...
        v = function (e) {
          ...
          return a.a.createElement(
            ...
            a.a.createElement(l.a, {
              disabled: !0,
              value: n,
              prefix: a.a.createElement(s.a, { type: "phone", style: { fontSize: 12, color: "rgba(0,0,0,0.4)" } }),
              marginTop: 16,
            }),
            a.a.createElement(
              "div",
                        ...
                        return w(this, function (n) {
                          switch (n.label) {
                            case 0:
                              return (
                                n.trys.push([0, 2, , 3]),
                                [4, Object(o.b)("/janus/api/mobile/sendVerificationCode", { type: 117 })]
                              );
                            case 1:
              ...
              !!p && a.a.createElement("div", { className: "msg-input-error" }, p)
            ),
            a.a.createElement(
              "div",
      ...
      var T = function (e, n, t, r) {
        ...
        N = function () {
          return Object(o.a)("/janus/api/queryPasswordEncrypt", {}).then(
            function (e) {
              var n = e || {};
              return { passwordEncrypt: n.passwordEncrypt, publicKey: n.publicKey };
            },
            function () {
        ...
        A = function (e) {
          return (
            (e.indexOf("//") > -1 ? e.split("/")[2] : e.split("/")[0]).split(":")[0].split("?")[0] || location.host
          );
        },
        j = function (e, n) {
          ...
          return (
            ...
            (function (e) {
              return !(
                ...
                e &&
                /^(https?\:)?\/\/.+/i.test(e) &&
                !/^(https?\:)?\/\/([a-zA-Z0-9]+)\.pinduoduo\.com(\/.*)?$/i.test(e)
              );
            })(e)
          );
        },
        ...
        W = function () {
          ...
          if (!P(e.redirectUrl)) return u.a.warn("\u975e\u6cd5\u7684 redirectUrl");
      ...
      var H = {
        ...
        L = window.ipcRenderer && "live_obs_electron" === window.LIVE_OBS_ELECTRON;
      var z,
        J = function () {
          if (-1 !== window.location.host.indexOf("mc.pinduoduo.com")) {
            ...
            (e = (function (e, n) {
              ...
              return t;
            })("redirectUrl", (e = window.location.href.replace("mc.pinduoduo.com", "mms.pinduoduo.com")))),
              (window.location.href = e);
          }
        },
        K = { htj: "//mc.htj.pdd.net/ddmc-mms/mc-login", prod: "//mc.pinduoduo.com/ddmc-mms/mc-login" },
        B = {
          pc: { htj: "https://mc.htj.pdd.net/ddmc-mms/", prod: "https://mc.pinduoduo.com/ddmc-mms/" },
        ...
        V = function (e) {
          ...
          ((!o ||
            B.host.includes(A(o)) ||
            ["fuwu.pinduoduo.com", "fuwu.htj.pdd.net", "open.pinduoduo.com", "open.htj.pdd.net"].includes(A(o))) &&
            o) ||
            (r.redirectUrl = t);
      ...
      var $ = function (e) {
          ...
          if (e === z.MC_AUDIT_SUCCESS)
            return (window.location.href = "/other/oneredirect?target=" + encodeURIComponent(n)), !0;
          if (e === z.MC_AUDIT_REJECT) return (window.location.href = "/home"), !0;
          if ([0, 1, 2, 3, 10].includes(e)) {
            var t = n + "checking";
            return (window.location.href = "/other/oneredirect?target=" + encodeURIComponent(t)), !0;
          }
          return !1;
        },
        q = function () {
              ...
              try {
                if (
                  ...
                  !(function (e, n) {
                    ...
                    (i = ""),
                    "XP" === o.version
                      ? (i = "http://commoncdn.yangkeduo.com/chrome/49.0.2623.75_chrome32_stable_windows_installer.exe")
                      : "Windows" === o.name
                      ? (i = "http://commoncdn.yangkeduo.com/chrome/71.0.3578.98_chrome_installer.exe")
                      : "Mac OS" === o.name &&
                        (i = "http://commoncdn.yangkeduo.com/chrome/GoogleChrome-71.0.3578.98.dmg"),
                    (c = g.a.alert({
          ...
          function (n) {
            for (;;)
              switch ((n.prev = n.next)) {
                case 0:
                  return (n.next = 2), o.a.awrap(Promise.all([t.e(0), t.e(5), t.e(7)]).then(t.bind(null, 1059)));
                case 2:
                  (e = n.sent.default),
                    u.a.render(
            ...
            for (;;)
              switch ((p.prev = p.next)) {
                case 0:
                  ...
                  return (p.next = 4), o.a.awrap(t.e(9).then(t.bind(null, 1056)));
                case 4:
                  (p.t0 = p.sent.default), (p.next = 10);
                  break;
                case 7:
                  return (p.next = 9), o.a.awrap(t.e(8).then(t.bind(null, 1063)));
                case 9:
                  p.t0 = p.sent.default;
                case 10:
                  return (e = p.t0), (p.next = 13), o.a.awrap(Promise.all([t.e(0), t.e(6)]).then(t.bind(null, 1058)));
                case 13:
                  (n = p.sent.default),
                    u.a.render(
                      a.a.createElement(a.a.Fragment, null, a.a.createElement(e, null), a.a.createElement(n, null)),
                      document.getElementById("root")
                    ),
                    (p.next = 26);
                  break;
                case 17:
                  try {
                    (r = /pddmt_[^_]+_version/.test(window.navigator.userAgent)),
                          ...
                          for (;;)
                            switch ((r.prev = r.next)) {
                              ...
                              case 9:
                                ...
                                break;
                              case 11:
                                (r.prev = 11), (r.t0 = r.catch(5)), console.error(r.t0);
                              case 14:
                                r.next = 3;
                                break;
                              case 16:
