...
import {
  COLL_GOODS_COMMENTS_DETAIL,
  COLL_GOODS_COMMENTS_LIST,
  URL_FETCH_COMMENTS_LIST,
  URL_FETCH_COMMENTS_SINGLE,
} from "../../const";
import { PddExtraParams } from "../../../../src/interface/pdd_base";
import { COMMENTS_DETAIL_KEYS } from "../../../../src/interface/pdd_goods_comments";
