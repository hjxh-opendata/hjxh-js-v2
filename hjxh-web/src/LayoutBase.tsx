...
export const LayoutBase = () => {
  ...
  return (
    <Layout style={{ minHeight: "100vh", minWidth: "100vw", display: "flex" }}>
      ...
      <Layout className={"site-layout"} style={{ width: "100%", height: "100vh", overflow: "auto" }}>
          ...
          <div id={"content"} style={{ padding: 24, minHeight: 600 }}>
            <Switch>
              ...
              <Route
                path={"/raw_ad_search"}
                exact
                component={() => <CompAdSearch url={"/ad/search"} />}
              />
              <Route
                path={"/raw_ad_scene"}
                exact
                component={() => <CompAdSearch url={"/ad/scene"} />}
              />
              <Route
                path={"/raw_ad_fangxin"}
                exact
                component={() => <CompAdFangxin url={"/ad/fangxin"} />}
              />
              <Route
                path={"/raw_goods_detail"}
                exact
                component={CompGoodsDetail}
              />
              <Route
                path={"/raw_goods_comments"}
                exact
                component={CompGoodsComments}
              />
